...
key_store = {
    'api_key': base64.b64encode(b'CHAOS').decode(),
    'admin_key': base64.b64encode(b'449CHAOS').decode()
}
cached_config = {
    'login_url': None,
    'version': None,
...
def get_account_credentials(region: str) -> str:
    # استخدام الحساب الجديد المقدم من المستخدم
    return "uid=5645547587&password=38E92336026B4768692FDF65C69052F8A0CFEF6C1C8DFFF04DE446382EC1EA27"
...
<head>
  ...
  <title>Free Fire Info API - CHAOS</title>
  <style>
...
<body>
  <div class="container">
    <h1>🔥 CHAOS CODEX Free Fire Info</h1>
    <div class="card">
      <h2>Player Lookup</h2>
